...
#  Description: This program tests several instances of recursion
...
def countAbc(str):
    if len(str) <= 2:
        return 0
    if str[0] == 'a' and str[1] == 'b' and (str[2] == 'c' or str[2] == 'a'):
...
def nestParen(str):
    ...
    if str[0] == '(' and str[last] == ')':
        return nestParen(str[first+1:last])
    else:
        return False
    ### FIX ME ###
